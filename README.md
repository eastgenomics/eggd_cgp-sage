...
## Notes
- **GRCh38 only**: all reference inputs (FASTA, hotspots, PON, panel BED) must use GRCh38 (`chr`-prefixed contigs); the app passes `-ref_genome_version 38` to SAGE and will not work with GRCh37 inputs.
